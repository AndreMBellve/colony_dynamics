...
[
  ...
  occupancy-limit ;;the maximum number of birds the patch can have currently
  burrow-limit ;;the absolute maximum number of burrows a patch can hold
...
to setup
  ...
  ;;Loading gis data and drawing maps
  set island-id-dataset gis:load-dataset colony-data
  set habitat-dataset gis:load-dataset habitat-data
...
91
colony-data
./data/population_simulation/abm_isl_id.asc
1
0
String
...
765
behav-output-path
./output/population_simulations/200_600_null/
1
0
String
...
155
habitat-data
./data/population_simulation/abm_burrows_small.asc
1
0
String
...
<experiments>
  ...
  <experiment name="200_600_pop_sim" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>step</go>
    <final>behav-csv</final>
    <timeLimit steps="500"/>
    ...
    <enumeratedValueSet variable="starting-adults">
      <value value="8000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="isl-att-curve">
      <value value="&quot;beta2&quot;"/>
    ...
    <enumeratedValueSet variable="behav-output-path">
      <value value="&quot;./output/population_simulations/200_600/&quot;"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="starting-juveniles">
      <value value="2000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="output-file-name">
      <value value="&quot;./output/test.csv&quot;"/>
    ...
    <enumeratedValueSet variable="colony-data">
      <value value="&quot;./data/population_simulation/abm_isl_id.asc&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="enso?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="habitat-data">
      <value value="&quot;./data/population_simulation/abm_burrows_small.asc&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-tries">
      <value value="6"/>
    </enumeratedValueSet>
  ...
  <experiment name="30_200_pop_sim" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>step</go>
    <final>behav-csv</final>
    <timeLimit steps="500"/>
    ...
    <enumeratedValueSet variable="behav-output-path">
      <value value="&quot;./output/population_simulations/30_200/&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="seed-id">
      <value value="42"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="habitat-data">
      <value value="&quot;./data/population_simulation/abm_burrows_tiny.asc&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-tries">
      <value value="6"/>
    </enumeratedValueSet>
  ...
  <experiment name="600_1800_pop_sim" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>step</go>
    <final>behav-csv</final>
    <timeLimit steps="500"/>
    ...
    <enumeratedValueSet variable="behav-output-path">
      <value value="&quot;./output/population_simulations/600_1800/&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="old-mortality">
      <value value="0.8"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="habitat-data">
      <value value="&quot;./data/population_simulation/abm_burrows_medium.asc&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-tries">
      <value value="6"/>
    </enumeratedValueSet>
  ...
  <experiment name="200_600_null" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>step</go>
    <final>behav-csv</final>
    <timeLimit steps="500"/>
    ...
    <enumeratedValueSet variable="behav-output-path">
      <value value="&quot;./output/population_simulations/200_600_null/&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="seed-id">
      <value value="42"/>
    </enumeratedValueSet>
